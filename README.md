...
All output (`stdout` and `stderr`) is written to the file `build.log` for convenience. Also, the locally built Flatpak is installed directly afterwards.
